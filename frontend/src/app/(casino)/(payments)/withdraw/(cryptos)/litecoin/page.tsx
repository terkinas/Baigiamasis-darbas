...
import { withdrawLitecoinFromBalance } from "@/lib/clientRequests";

export default function LitecoinWithdrawPage() {
  ...
  function handleWithdraw() {
    withdrawLitecoinFromBalance(Number(coins), withdrawAddress)
  }

  return (
    <div className="max-w-xl mx-auto text-white py-6 flex flex-col gap-2">
      <h1 className="flex flex-row gap-2 text-xl">Withdraw with Litecoin <Image className="object-contain" src="/images/payments/litecoin.png" alt="Litecoin" width={25} height={25} /> </h1>
      ...
      <div className="w-full pt-6">
        ...
        shadow-lg bg-custom-gray-700 rounded">
          ...
          border border-custom-gray-600">
            ...
            <input value={withdrawAddress} onChange={(e) => setWithdrawAddress(e.target.value)} type="text" maxLength={57} className="bg-transparent outline-none w-full text-xs md:text-sm " placeholder="Your litecoin wallet address" />
      ...
      <div className="w-full h-10 bg-custom-orange-500 bg-opacity-10 flex flex-row gap-3 items-center">
        ...
        <h4 className="text-sm text-custom-orange-500">Only withdraw over the Litecoin Network!</h4>
      </div> 
...
<div className="w-full border border-custom-gray-600 shadow-lg rounded
          ...
          <div className="flex gap-1 justify-center">
            ...
            <span>|</span>
            <p className="text-center text-xs md:text-sm text-custom-gray-400 flex gap-1 items-center">Est. Network Fee  <span className="text-custom-gray-100">0.05$</span></p>
